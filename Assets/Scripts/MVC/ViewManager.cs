...
public class ViewManager 
{
    ...
    public void Open(int key, params object[] args)
    {
        ...
        if (view == null)
        {
            ...
            GameObject uiObj = UnityEngine.Object.
                Instantiate(Resources.
                    Load($"View/{viewInfo.PrefabName}"), viewInfo.parentTf) as GameObject;//生成uiobj
            ...
            //在这里添加脚本
            view = uiObj.AddComponent(Type.GetType(type)) as IBaseView;//添加View脚本
